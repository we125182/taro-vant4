...
<template>
  <demo-block :title="t('basicUsage')">
    <div style="">
      ...
      <div style="margin-top: 10px">
        <VanButton @click="() => (isStart = true)" type="primary">{{
          t('rollDown')
        }}</VanButton>
      </div>
    </div>
  ...
  <demo-block :title="t('direction')">
    <div>
      ...
      />
      <div style="margin-top: 10px">
        <VanButton @click="() => (isStart2 = true)" type="primary">{{
          t('rollUp')
        }}</VanButton>
      </div>
    </div>
  ...
  <demo-block :title="t('stopOrder')">
    <div>
      ...
      />
      <div style="margin-top: 10px">
        <VanButton @click="() => (isStart3 = true)" type="primary">{{
          t('stopFrom')
        }}</VanButton>
      </div>
    </div>
  ...
  <demo-block :title="t('noNumberType')">
    <div>
      ...
      />
      <div style="margin-top: 10px">
        <VanButton @click="() => (isStartNoNumberType = true)" type="primary">{{
          t('start')
        }}</VanButton>
      </div>
    </div>
