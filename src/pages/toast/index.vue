...
import { ref } from 'vue';
import { cdnURL, useTranslate } from '@/utils';
import {
  showToast,
  showFailToast,
  showSuccessToast,
...
import type { ToastWordBreak } from 'vant'
...
<template>
  ...
  <demo-block card :title="t('useComponent')">
    ...
    <van-toast v-model:show="show" style="padding: 0" :duration="2000" :overlay-style="{animationDuration:'0.3s'}">
      <template #message>
        <van-image
          :src="image"
          width="200"
